            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="center"><center><?php echo $r_order_fiks['jumlah'];?></center></td>
                  <td class="center"><center>Rp. <?php echo $r_order_fiks['harga'];?></center>,-</td>
                  <td class="center">
                    <center><strong>
                      Rp.
                      <?php 
                ...
                <tr>
                  ...
                  <td class="right"></td>
                  <td class="right"></td>
                  <td class="right"><center><strong>Rp. <?php echo $result_harga['total_harga'];?>,-</strong></center></td>
                </tr>
                <tr>
                  <td></td>
                ...
                <tr>
                  <td></td>
                  <td><strong><center>Waktu</center></strong></td>
                  <td class="right"></td>
                  <td class="right"></td>
                  <td class="right"><center><strong><?php echo $result_harga['waktu_pesan'];?>,-</strong></center></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th style="width: 500%">Menu Pesanan</th>
              ...
              ?>
                ...
                <tr class="odd gradeX">
                  ...
                  <td>
                    <center>
                      <input class="span8" name="waktu_pesan" type="datetime-local" value="" placeholder="" />
                    </center>
                  </td>
                  <td>
